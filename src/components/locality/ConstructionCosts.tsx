...
import { Building, Hammer, Calendar, ChevronDown, ChevronUp } from "lucide-react";
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mt-4">
      ...
      >
        <div className="flex flex-col items-start text-left">
          <h2 className="text-xl font-bold text-gray-900">Construction Costs</h2>
          {!isOpen && (
            <p className="text-sm text-gray-500 mt-1">
              Starts from ₹{locality.construction_first_class?.toLocaleString() || "15,000"}/sqm • View Depreciation
            </p>
          )}
        </div>
        ...
        <div className="p-6 pt-0 border-t border-gray-50">
          <div className="grid md:grid-cols-2 gap-6 mb-8 mt-4">
            <div className="bg-gradient-to-br from-slate-50 to-gray-50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">First-class Construction</h3>
            ...
            <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Second-class Construction</h3>
                  <p className="text-sm text-gray-600">Basic materials, tin roofing</p>
                </div>
              </div>
          ...
          <div className="bg-gray-50 rounded-xl p-6">
              ...
              {depreciationRates.map((rate, index) => (
                <div key={index} className="flex justify-between items-center py-2">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-semibold text-gray-900">{rate.factor}%</span>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200 text-sm text-gray-600">
              <strong>Note:</strong> Depreciation applies to constructed properties only. Land value doesn't depreciate.
            </div>
          </div>
        </div>
      )}
